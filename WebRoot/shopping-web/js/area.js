...
var s2=["province","city","county"];
var opt0 = ["省份","地级市","市、县级市"];//初始值
function _init_opt0(province,city,county){ //初始化初始值
	opt0[0]=province;
	opt0[1]=city;
	opt0[2]=county;
//	document.getElementById(s[0]).value=province;
//	document.getElementById(s[1]).value=city;
//	document.getElementById(s[2]).value=county;
}
...
function _init2(){
	for(i=1;i<s.length-1;i++){
	  document.getElementById(s2[i]).onchange=new Function("change("+(i+1)+")");
	}
	change(0);
}
