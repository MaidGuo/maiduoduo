...
<%
	...
	notice = (NoticeInfo) request.getSession().getAttribute("notice");
...
<body>
	<form name="frm" action="<%=path%>/servlet/NoticeEditAction"
		method="post">
	<!--  	<div class="container">
														...
														<thead>
															...
															<tr>
																<td><textarea
																		...
																		name="content" id="content"><%=notice.getNotice_content()%></textarea></td>
															</tr>
														</thead>
													</table>
												</form>
